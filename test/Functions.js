...
describe("Functions", () => {
  describe("Example 1", () => {
    ...
    it("demonstrate a write function with arguments", async () => {
      await contract.setName("new name");
      expect(await contract.getName()).to.equal("new name");
    });

    it("demonstrates write functions without arguments", async () => {
      await contract.setName("new name");
      expect(await contract.getName()).to.equal("new name");
    ...
    it("demonstrate write functions cost gas", async () => {
      let balanceBefore = await ethers.provider.getBalance(deployer.address);
  ...
  describe("Example 2", () => {
    ...
    it("demonstrates a function being called by another function", async () => {
  ...
  describe("Example 3", () => {
    ...
    it("demonstrates a function being called outside of the contract", async () => {
      await contract.increment();
      expect(await contract.count()).to.equal(1);
    });
  });
  ...
  describe("Example 4", () => {
    ...
    // It won't compile
    it("can call an external function outside of the contract", async () => {
  ...
  describe("Example 5", () => {
    ...
    it("demonstrates a pure function", async () => {
  ...
  describe("Example 7", () => {
    ...
    it("return default value if no return is provided", async () => {
      expect(await contract.getName2()).to.equal("");
    });

    it("returns value of an existing function inline", async () => {
    ...
    it("can read multiple values from another function", async () => {
      let result = await contract.getName6();
      expect(result[0]).to.equal("Example 7");
      expect(result[1]).to.equal("New name");
    });
