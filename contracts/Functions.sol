...
// Functions can be declared outside of the contract
...
contract Functions4 {
    ...
    // You cannot call this function outside the contract
...
contract Functions5 {
    ...
    // You *can* access state (e.g. read name)
    function getName() public view returns(string memory) {
        return name;
    }
    ...
    // Pure 
    // You *cannot* modify state (e.g. change name)
    // You *cannot* access state (e.g. read name)
